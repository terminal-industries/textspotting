...
json_file = '/mnt/ssd4T/steven/projects/DeepSolo/datasets/ic15/train_37voc.json'
img_root = '/mnt/ssd4T/steven/projects/DeepSolo/datasets/ic15/train_images'
...
def draw_annotations(json_file_path,img_root):
    ...
    for image_info in data['images']:
        ...
        for annotation in [a for a in data['annotations'] if a['image_id'] == image_info['id']]:
            ...
            draw.text((bbox[0] + 5, bbox[1] + 5), text, fill='black')
